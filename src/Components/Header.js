import laryHead from "../images/lary-head.svg";
    ...
    return (
        <header className="max-w-xl mx-auto mt-20 text-center">
            ...
            <h2 className="inline-flex mt-2">
                By Lary Laracore
                <img src={laryHead} alt="Head of Lary the mascot"></img>
            </h2>
            ...
            <div className="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
                <div className="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
                    ...
                    <svg className="transform -rotate-90 absolute pointer-events-none" style={{right: "12px"}}
                         width="22"
                ...
                <div className="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl px-3 py-2">
                    <form method="GET" action="#">
                        <input type="text" name="search" value="" placeholder="Find something" className="bg-transparent placeholder-black font-semibold text-sm" />
                    </form>
                </div>
            </div>
        </header>
